  ...
  return (
    ...
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/login" element={<LoginView user={userAuth} setUserAuth={setUserAuth} isAllowed={!!userAuth} redirect="/home" />}></Route>
        
        <Route element={<ProtectedRoutes />}>
        
          <Route path="/home" element={<Home/>}></Route>
          <Route path="/clientes" element={<ClienteView />}></Route>
          <Route path="/consultar-clientes" element={<ConsultarClientes />}></Route>
