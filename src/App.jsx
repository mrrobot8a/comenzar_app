    ...
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route element={<ProtectedRoutes />}>
          ...
          <Route
            path="/consultar-campañas"
            element={<ConsultarCampañas />}
          ></Route>
          <Route path="/facturas" element={<FacturaView />}></Route>
          <Route
            path="/redimir-facturas"
            element={<RedimirFacturaView />}
          ></Route>
          ...
          <Route
            path="/tienda-estadistica"
            element={<TiendaEstadistica />}
          ></Route>
          <Route
            path="/consultar-tiendas"
            element={<ConsultarTiendas />}
          ></Route>
          <Route path="/profesiones" element={<ProfesionView />}></Route>
          <Route
            path="/consultar-profesiones"
            element={<ConsultarProfesiones />}
          ></Route>
        </Route>
