                    ...
                    <div className="container_formulario_request-d justify-content-center  ">
                        <div className="text_info d-none d-lg-block">
                            <h1 className="my-5 display-7 fw-bold ls-tight">
                                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Necessitatibus, repudiandae earum. Aliquid totam mollitia itaque est nihil? Tempore, autem neque. Eveniet temporibus ab ex natus repellat provident pariatur sapiente voluptas.      CRM para Centros Comerciales <br />
                            </h1>
