...
export const ClienteView = () => {
  ...
  const consultarApi = async () => {
    // Simulación de una llamada a la API que devuelve datos
    const datosApi = {
      nombre: 'John',
      apellido: 'Doe',
      telefono: '123456789',
  ...
  const handleConsult = async (e) => {
    e.preventDefault();
    const datosApi = await consultarApi();

    // Actualiza el estado con los datos obtenidos de la consulta
    setDatosConsulta(datosApi);
                          ...
                          <div className="row">
                            ...
                            <div className="col-md-6 mb-4">
                              <div className="form-outline">
                                ...
                                <CustomInput labelPlaceholder="N° 1231282" idInput="formCelular" type="tel" value={datosConsulta.telefono} />
                              </div>
                            </div>
                          </div>
                          <div className="row">
                            <div className="col-md-6 mb-4">
                              <div className="form-outline">
                                ...
                                <CustomInput labelPlaceholder="# Celular" idInput="formCelular" type="tel" value={datosConsulta.telefono} />
                              </div>
                            </div>
                            <div className="col-md-6 mb-4">
                              <div className="form-outline">
                                ...
                                <CustomInput labelPlaceholder="example@example.com" idInput="formEmail" type="email" value={datosConsulta.correo} />
                              </div>
                            </div>
                          </div>
                          <div className="col-md-12 mb-4">
                            <div className="form-outline">
                              ...
                              <CustomInput labelPlaceholder="example av.33 #23-34" idInput="formDireccion" type="text" value={datosConsulta.direccion} />
                            </div>
                          </div>
                          <div className="row">
                            <div className="col-md-6 mb-4">
