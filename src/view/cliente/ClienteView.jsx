...
export const ClienteView = () => {
    ...
    // Simulación de función de consulta a la API
                                                    ...
                                                    <div className="row">
                                                        <div className="col-md-6 mb-4">
                                                            <div className="form-outline">
                                                                <label className="form-label" htmlFor="form3Example1">Nombres completo</label>
                                                                <CustomInput labelPlaceholder="Nombre cliente" idInput="formNombre" type="text" value={datosConsulta.nombre} />
                                                            </div>
                                                        </div>
                                                        <div className="col-md-6 mb-4">
                                                            <div className="form-outline">
