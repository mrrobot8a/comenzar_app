        ...
        <>
            <div className="container_formulario_request  ">
                <div className="row   m-2 ">
                    <h2 className="tituloTabla text-center mb-4 mt-4">CONSULTA TICKETS DEL CLIENTE ASIGNADOS</h2>
                    ...
                    <div className="col-sm-12 col-md-12 col-lg-7 col-xl-7 col-12 mb-5 mb-lg-0 mt-lg-3 mt-4 px-4">
                        <h2 className="tituloTabla text-center mb-4">TICKETS ASIGNADOS</h2>
                        ...
                        <div className="row justify-content-end" id="row_table">
                            ...
                            <div className="col-md-8 col-lg-12 col-12 d-flex mb-4 mt-3 justify-content-end">
                                ...
                                <div className="form-outline">
                                    <CustomInput
                                        labelPlaceholder="No de  Tickets Asignados"
